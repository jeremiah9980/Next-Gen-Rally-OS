#!/usr/bin/env node
// Validates cms/content/nextgen-site.json against cms/schema/nextgen-site.schema.json
// plus a few hand-written rules the JSON Schema alone can't express cleanly.
// Usage: node scripts/validate-cms-content.mjs [path-to-json]
...
const contentPath = process.argv[2] || path.join(__dirname, "..", "cms", "content", "nextgen-site.json");
const schemaPath = path.join(__dirname, "..", "cms", "schema", "nextgen-site.schema.json");
