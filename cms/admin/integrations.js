/* NextGen Integration Center.
   All state lives in localStorage as a per-team draft; nothing here writes to the
   repo directly. "Export site JSON" merges rosters into cms/content/nextgen-site.json
...
(function () {
  ...
  var KEY = "nextgen_integrations_v1";
  ...
  var FALLBACK_TEAMS = [
    { id: "nextgen-10u", name: "NextGen 10U" },
    { id: "nextgen-12u", name: "NextGen 12U" },
    { id: "nextgen-elite-12u", name: "NextGen Elite 12U" }
  ];
  ...
  var DEMO_TEAMS = [
    { id: "ncs-84121", name: "NextGen 10U", division: "10U", location: "TX" },
    { id: "ncs-87310", name: "NextGen 12U", division: "12U", location: "TX" },
    { id: "ncs-87455", name: "NextGen Elite 12U", division: "12U", location: "TX" },
  ...
  function demoEvents(teamIds) {
    return teamIds.filter(Boolean).map(function (id, i) {
      return {
        ...
        name: ["Lone Star Kickoff", "Gold Glove Classic", "NextGen Invitational"][i % 3],
  ...
  function exportSiteJson() {
    fetch("../content/nextgen-site.json").then(function (r) {
      if (!r.ok) throw new Error("Could not load ../content/nextgen-site.json (serve the site with `npx serve .`)");
      return r.json();
    }).then(function (site) {
      ...
      download("nextgen-site.json", JSON.stringify(site, null, 2));
  ...
  $("#exportConfig").onclick = function () { download("nextgen-integrations.json", JSON.stringify(state, null, 2)); };
  ...
  fetch("../content/nextgen-site.json").then(function (r) { return r.ok ? r.json() : null; }).then(function (site) {
